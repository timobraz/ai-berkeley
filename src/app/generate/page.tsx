...
export default function Upload() {
  ...
  const [messages, setMessages] = useState<string[]>(["Generating your markdown report"]);
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const resp = await fetch("https://flowing-magpie-sweet.ngrok-free.app/generate_report", {
        ...
        body: JSON.stringify({
          description: "This is an AI company focused on creating headshots for people using stable diffusion",
          fields: [
            {
