...
export default function Home() {
  return (
    <div className="inset-0 -z-10 h-full w-full bg-white bg-[radial-gradient(#B1B1B1_1px,transparent_1px)] [background-size:48px_48px] min-h-screen snap-y  overflow-y-scroll  snap-mandatory ">
      ...
      <div className="h-screen flex px-32 flex-col gap-8 snap-start py-16">
        ...
        <div className="bg-green-dots w-full flex flex-col items-center py-12 rounded-xl">
        ...
        <div className="bg-green-dots w-full flex flex-col items-center py-12 rounded-xl">
          <div className="flex flex-col gap-2 relative -top-4 w-1/2">
            ...
            {/* <div className="flex gap-4 items-center justify-between h-14 w-full">
              <label htmlFor="filePicker" className="w-full h-64 bg-white outline-2">
