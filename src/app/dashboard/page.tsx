...
export default function dashboard() {
  return (
    <div className="h-screen w-full bg-white bg-[radial-gradient(#B1B1B1_1px,transparent_1px)] [background-size:48px_48px]">
      {" "}
      <Navbar />
      <div>
        ...
        <div className=" w-[92%] left-[4%] h-[850px] relative top-[100px]">
          <div className="w-[45%] h-[100%] right-0 bg-blue-100 absolute top-0 rounded-md"></div>
